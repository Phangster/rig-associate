...
import Sompo from '../../images/sompo.png';
    ...
    <div backgroundClassName={classes.background}>
        <div style={containerDiv}>
            ...
            <div style={{color:'black', display: 'grid'}}>
                <img src={Sompo} style={imageLogo} alt="Sompo"/>
                <Button
                    color="primary"
                    variant="contained"
                    size="large"
...
export default withStyles(styles)(SompoHero);